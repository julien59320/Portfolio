  ...
  <section class="education" id="education">
    ...
    <div class="box-container">
      <div class="box">
        ...
        <span>2022</span>
        <h3>Recherche Stage 3 mois</h3>
        <p>
          Pour valider ma formation Développeur web et web mobile, je suis à la recherche d'un stage de 3 mois
          non rémunérer pour la période du 14.03.2022 au 10.06.2022.
        </p>
      </div>
      ...
      <div class="box">
        ...
        <h3>Chef Boucher</h3>
        <p>
          Expérience qui ma permit d'acquérir de nombreuses compétences en management d'équipe, sens relationnel et
          contact avec la clientèle, ou encore en gestion administrative et commerciale.
        </p>
      </div>
    </div>
  </section>
